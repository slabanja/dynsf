...
import unittest
from dsf.trajectory_reader.lammpstrj_trajectory_reader import (
    lammpstrj_trajectory_reader as trajectory_reader)
...
class LAMMPSTRJTrajectoryReaderTest(unittest.TestCase, TrajectoryReaderTestMixin):
